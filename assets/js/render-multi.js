...
  // This MUST be run first to fix the menu immediately.
  setupNavToggle();

  // MODIFIED: Only run page-specific functions if their target element exists.
  // This prevents the TypeError crash from propagating.
  
  // Home Page (always safe to run or has its own internal checks)
  renderGroupHome();

  // Banquets page
  if (document.getElementById('banquet-list')) {
    renderBanquets();
  }
  
  // Directory page
  if (document.getElementById('directory-info')) {
    renderDirectory();
  }
...
  if (document.getElementById('product-grid')) {
  ...
  // Order page (this was the source of the crash)
